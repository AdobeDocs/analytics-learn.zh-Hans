...
description: 您可以使用 Adobe Analytics 中的多种方式将归因方法提升到新的高度。 在此视频中，我们将重点介绍如何使用 Workspace 中的跨选项卡分析，从营销渠道报告中获得更加深入的洞察。
...
您可以使用 Adobe Analytics 中的多种方式将归因方法提升到新的高度。 在此视频中，我们将重点介绍如何使用 Workspace 中的跨选项卡分析，从营销渠道报告中获得更加深入的洞察。
