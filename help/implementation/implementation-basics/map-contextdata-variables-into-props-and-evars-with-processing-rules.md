...
# 使用处理规则将contextData变量映射到prop和eVar {#map-contextdata-variables-into-props-and-evars-with-processing-rules}
...
>[!IMPORTANT]
>
>如果您未使用Adobe Analytics标签（标签管理器），则本文和视频适用于Adobe Experience Platform的“AppMeasurement”实施。
