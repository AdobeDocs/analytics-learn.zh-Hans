...
+ Analytics 简介{#intro-to-analytics}
   ...
   + Analytics 基础{#analytics-basics}
      ...
      + [人员指标](intro-to-analytics/analytics-basics/people-metric.md)
...
+ Analysis Workspace {#analysis-workspace}
   ...
   + 在 Workspace 项目中导航{#navigating-workspace-projects}
      + [在 Analysis Workspace 中开始您的第一个项目](analysis-workspace/navigating-workspace-projects/starting-your-first-project-in-analysis-workspace.md)
      ...
      + [在 Analysis Workspace 中撤消操作](analysis-workspace/navigating-workspace-projects/undoing-actions-in-analysis-workspace.md)
      ...
      + [使用左侧边栏中的过滤器（标签）](analysis-workspace/navigating-workspace-projects/using-filters-tags-in-the-left-rail.md)
   + 使用面板{#using-panels}
   ...
   + 构建自由格式表{#building-freeform-tables}
      ...
      + [使用 Analysis Workspace 中的右键单击菜单](analysis-workspace/building-freeform-tables/using-the-right-click-menu.md)
      + [Analysis Workspace 中的右键单击菜单（续）](analysis-workspace/building-freeform-tables/continued-right-click-menu-in-analysis-workspace.md)
      + [Analysis Workspace 中的交叉销售分析](analysis-workspace/building-freeform-tables/cross-sell-analysis-workspace.md)
      + [自由格式表过滤器](analysis-workspace/building-freeform-tables/freeform-table-filters.md)
      + [Analysis Workspace 中的时间划分维度](analysis-workspace/building-freeform-tables/time-parting-dimensions-in-analysis-workspace.md)
      + [Analysis Workspace 中的自由格式表总计](analysis-workspace/building-freeform-tables/freeform-table-totals-in-analysis-workspace.md)
   + 可视化{#visualizations}
   ...
   + 应用区段{#applying-segments}
      ...
      + [临时区段](analysis-workspace/applying-segments/ad-hoc-temporary-segments.md)
   ...
   + 指标{#metrics}
      ...
      + [在 Analysis Workspace 中将维度和指标添加到您的项目](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/dimensions/adding-dimensions-and-metrics-to-your-project-in-analysis-workspace.html)
      + [转化事件简介](analysis-workspace/metrics/introduction-to-conversion-events.md)
      + [在自由格式表中使用指标](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/building-freeform-tables/working-with-metrics-in-a-freeform-table.html)
   ...
   + 分析客户历程{#analyzing-customer-journeys}
      ...
      + [流可视化图表](analysis-workspace/analyzing-customer-journeys/flow-visualization.md)
   ...
   + 简化和共享项目{#curate-and-share-projects}
      ...
      + [以 CSV 格式下载 50000 项](analysis-workspace/curate-and-share-projects/download-50000-items-as-csv.md)
      + [从 Analysis Workspace 导出到 CSV](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/exporting/from-the-ui/export-to-csv-from-analysis-workspace.html)
   ...
   + Attribution IQ{#attribution-iq}
      ...
      + [Attribution IQ 在计算指标中](analysis-workspace/attribution-iq/attribution-iq-in-calculated-metrics.md)
...
+ 实施{#implementation}
   ...
   + 通过 Experience Platform Launch{#via-adobe-launch}
      + [用 Experience Platform Launch 在网站中实施 Experience Cloud](https://docs.adobe.com/content/help/zh-Hans/experience-cloud/implementing-in-websites-with-launch/index.html)
   ...
   + 验证和故障排除{#validating-and-troubleshooting}
      ...
      + [用 Experience Cloud Debugger 查看后处理的点击](implementation/validating-and-troubleshooting/view-post-processed-hits-with-the-experience-cloud-debugger.md)
   + SPA 页面{#spa-pages}
...
+ 组件{#components}
   ...
   + 计算指标{#calculated-metrics}
      ...
      + [Attribution IQ 在计算指标中](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/attribution-iq/attribution-iq-in-calculated-metrics.html)
      ...
      + [计算指标 - 指标选择器](components/calculated-metrics/calculated-metrics-metric-selector.md)
...
+ 移动应用程序分析{#mobile-app-analytics}
   + 实施{#implementation}
      ...
      + [在 iOS Swift 应用程序中实施](https://docs.adobe.com/content/help/zh-Hans/experience-cloud/implementing-in-mobile-ios-swift-apps-with-launch/index.html)
      + [在 iOS Objective-C 应用程序中实施](https://docs.adobe.com/content/help/zh-Hans/experience-cloud/implementing-in-mobile-ios-objective-c-apps-with-launch/index.html)
      + [在 Android 应用程序中实施](https://docs.adobe.com/content/help/zh-Hans/experience-cloud/implementing-in-mobile-android-apps-with-launch/index.html)
